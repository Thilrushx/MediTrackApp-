...
export default function CaregiverPage() {
  ...
  // Back-end already scopes getPatients to the caregiver's assigned patients,
  // but filter client-side too so the UI is consistent even if extra rows leak through.
  const caregiverPatients = patients.filter(p => p.caregiverId === user?.id);
