...
// All other routes are protected — verifyToken is applied inside each router
...
const seed = async () => {
  ...
  // ── Users — inserted via raw SQL so passwordHash is never silently dropped ──
  ...
  // ── Patients (clinical records, each linked to a User via userId) ─────────
  await Patient.bulkCreate([
    {
      id: 'pat-1', name: 'William Johnson', age: 82, gender: 'Male',
      condition: 'Diabetes, Hypertension', phone: '+1 (555) 100-2001',
      email: 'william@example.com',
      doctorId: 'usr-doc-1', caregiverId: 'usr-cgv-1', userId: 'usr-pat-1',
    },
    {
      id: 'pat-2', name: 'Margaret Lee', age: 74, gender: 'Female',
      condition: 'Cholesterol, Arthritis', phone: '+1 (555) 100-2002',
      email: 'margaret@example.com',
      doctorId: 'usr-doc-1', caregiverId: 'usr-cgv-2', userId: 'usr-pat-2',
    },
    {
      id: 'pat-3', name: 'Robert Chang', age: 68, gender: 'Male',
      condition: 'Heart Disease', phone: '+1 (555) 100-2003',
      email: 'robert@example.com',
      doctorId: 'usr-doc-1', caregiverId: 'usr-cgv-1', userId: 'usr-pat-3',
    },
  ]);
  ...
  await PatientNote.bulkCreate([
    {
      id: 'note-1', date: '2026-06-12',
      noteText:        'Took Metformin in evening but felt mild nausea.',
      sentiment:       'Neutral',   riskLevel: 'Low',
      sideEffects:     'Mild nausea',
      riskAnalysis:    'Minor GI distress.',
      recommendations: 'Take with full meal.',
    },
    {
      id: 'note-2', date: '2026-06-13',
      noteText:        'Forgot morning Lisinopril, took it late at 2PM.',
      sentiment:       'Apprehensive', riskLevel: 'Medium',
      sideEffects:     'Headache',
      riskAnalysis:    'Forgetting medication when leaving home.',
      recommendations: 'Set double alarm.',
    },
  ]);
